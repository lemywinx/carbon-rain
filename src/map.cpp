...
/* x2  is smaller than x1 and y2  is smaller than  y1.
 * Being able to dig with *2 coords smaller than *1 will be handy for corridor
 * digging
 */
    ...
    for (int y = 0; y < height; y++) {
      if (isInFov(x, y)) {
        TCODConsole::root->setCharBackground(
            x, y, isWall(x, y) ? lightWall : lightGround);
